...
JavaScript is a hard language to master. It has its share of quirks, gotchas, and [wats](https://www.destroyallsoftware.com/talks/wat), but it's powerful and expressive, and its been evolving rapidly since ES5. It's here to stay, and its everywhere. [It's even in space](https://nodejs.org/static/documents/casestudies/Node_CaseStudy_Nasa_FNL.pdf).
